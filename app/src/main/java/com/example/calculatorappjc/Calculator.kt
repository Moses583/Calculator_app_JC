...
import com.example.calculatorappjc.ui.theme.LightGray
import com.example.calculatorappjc.ui.theme.Orange
...
fun Calculator(
    ...
    Box(modifier = modifier){
        Column(
            ...
            Text(
                text = state.number + (state.operation?: "")+state.number,
            ...
            Row(
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        ...
                        .weight(1f),
                    onClick = {
                        onActions(CalculatorActions.Operation(CalculatorOperation.Substract))
                    }
                )
            }
            Row(
